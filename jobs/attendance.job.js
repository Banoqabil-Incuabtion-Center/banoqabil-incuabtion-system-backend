...
const initAttendanceJobs = () => {
    ...
    cron.schedule("55 23 * * *", async () => {
        try {
            console.log("⏳ Running automated absence marking job...");
            ...
            console.log(`✅ Absence Job Completed. Processed ${parsedUsers} users. Marked ${markedAbsent} as Absent.`);
...
module.exports = initAttendanceJobs;
